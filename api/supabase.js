...
const CLOTHES_TABLE = process.env.SUPABASE_CLOTHES_TABLE || 'clothes';
const OUTFITS_TABLE = process.env.SUPABASE_OUTFITS_TABLE || 'outfits';
const BUCKET = process.env.SUPABASE_BUCKET || 'wardrobe';
